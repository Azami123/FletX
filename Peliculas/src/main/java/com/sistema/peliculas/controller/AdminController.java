package com.sistema.peliculas.controller;
...
import com.sistema.peliculas.repositorio.GeneroRepositorio;
import com.sistema.peliculas.repositorio.PeliculaRepositorio;
import com.sistema.peliculas.servicio.AlmacenServicioImpl;
...
public class AdminController {
	...
	public ModelAndView mostrarFormularioDeNuevaPelicula() {
		...
		return new ModelAndView("admin/nueva_pelicula")
	...
	public ModelAndView mostrarFormilarioDeEditarPelicula(@PathVariable Integer id) {
		...
		return new ModelAndView("admin/editar_pelicula")
				.addObject("pelicula",pelicula)
				.addObject("generos",generos);
	}
